...
alter table game add constraint fk_game_developer_1 foreign key (developer_id) references users (id) on delete restrict on update restrict;
create index ix_game_developer_1 on game (developer_id);
